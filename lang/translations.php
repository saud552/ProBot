...
return [
    ...
    'fa' => [
        ...
        'strings' => [
            ...
            'support_intro' => '需要協助嗎？開啟工單，我們會儘快回覆。',
            'support_new_ticket_button' => '開啟工單',
            'support_my_tickets_button' => '我的工單',
            'support_ticket_subject_prompt' => '請輸入工單的簡短主題。',
            'support_ticket_message_prompt' => '請描述您的問題。',
            'support_ticket_created' => '工單已建立，我們將儘快聯繫您。',
            'support_ticket_list_title' => '我的工單',
            'support_ticket_list_empty' => '尚未有工單。',
            'support_ticket_reply_prompt' => '請輸入您的回覆。',
            'support_ticket_closed' => '工單已關閉，謝謝。',
            ...
            'support_waiting_for_admin' => '已送出，請等待客服回覆。',
            'support_admin_reply_notice' => '客服已回覆您的工單。',
            'support_admin_reply_sent' => '已將回覆傳送給用戶。',
            'support_input_cancelled' => '操作已取消。',
            'user_banned' => '您已被限制使用此機器人。',
            ...
            'admin_section_forcesub' => '強制訂閱',
            'admin_section_referrals' => '推薦計畫',
            'admin_features_title' => '功能開關',
            'admin_stars_title' => 'Stars 付款設定',
            'admin_stars_enabled_label' => '狀態',
            'admin_stars_price_label' => '每顆 Star 的美元價',
            ...
            'admin_forcesub_channel_prompt' => '請以 ID|https://t.me/... 格式提供頻道 ID 與連結。',
            'admin_forcesub_channel_updated' => '頻道已更新。',
            'admin_referrals_hint' => '使用 /referrals <telegram_id> 檢視推廣夥伴。',
            'admin_referrals_toggle_button' => '切換推薦計畫',
            'admin_users_title' => "用戶管理\n使用 /user <telegram_id>\n使用 /ban、/unban",
            'admin_user_id_prompt' => '請輸入有效的 Telegram ID。',
            'admin_user_not_found' => '找不到該用戶。',
            'admin_user_updated' => '用戶資訊已更新。',
            'admin_user_status_banned' => '已封鎖',
            'admin_user_status_active' => '啟用中',
            'admin_user_ban_button' => '封鎖用戶',
            'admin_user_unban_button' => '解除封鎖',
            'referral_disabled' => '推薦計畫已停用。',
            'referral_title' => 'Referral Program',
            'referral_link_label' => "Share link:\n__link__\nCode: __code__",
            'referral_stats' => "Invited: __invited__\nPending: __pending__\nAvailable: __eligible__$\nPaid: __rewarded__$",
            'referral_withdraw_button' => 'Withdraw earnings',
    ...
    'cht' => [
        ...
        'strings' => [
            ...
            'support_intro' => '需要帮助吗？请提交工单，我们会尽快回复。',
            'support_new_ticket_button' => '提交工单',
            'support_my_tickets_button' => '我的工单',
            'support_ticket_subject_prompt' => '请填写工单的简短主题。',
            'support_ticket_message_prompt' => '请描述您的问题。',
            'support_ticket_created' => '工单已创建，我们会尽快联系您。',
            'support_ticket_list_title' => '我的工单',
            'support_ticket_list_empty' => '暂无工单。',
            'support_ticket_reply_prompt' => '请输入您的回复。',
            'support_ticket_closed' => '工单已关闭，感谢使用。',
            'support_ticket_reply_button' => '回复',
            'support_ticket_close_button' => '关闭',
            'support_ticket_header' => '工单',
            'support_ticket_status_label' => '状态',
            'support_ticket_subject_label' => '主题',
            'support_admin_label' => '客服',
            'support_user_label' => '您',
            'support_waiting_for_admin' => '回复已发送，请等待客服处理。',
            'support_admin_reply_notice' => '客服已回复您的工单。',
            'support_admin_reply_sent' => '回复已发送给用户。',
            'support_input_cancelled' => '操作已取消。',
            'user_banned' => '您已被禁止使用此机器人。',
            'feature_disabled' => '该功能目前停用。',
            'admin_only' => '仅限管理员。',
            'admin_panel_button' => '管理面板',
            'admin_panel_title' => '管理员面板',
            'admin_section_tickets' => '工单',
            'admin_section_users' => '用户',
            'admin_section_features' => '功能',
            'admin_section_stars' => 'Stars 付款',
            'admin_section_forcesub' => '强制关注',
            'admin_section_referrals' => '推广计划',
            'admin_features_title' => '功能开关',
            'admin_stars_title' => 'Stars 付款设置',
            'admin_stars_enabled_label' => '状态',
            'admin_stars_price_label' => '每个 Star 的美元价',
            'admin_stars_toggle_button' => '切换',
            'admin_stars_set_price_button' => '设置价格',
            'admin_prompt_star_price' => '请输入每个 Star 的美元价格。',
            'admin_star_price_updated' => 'Star 价格已更新。',
            'admin_forcesub_title' => '强制关注设置',
            'admin_forcesub_toggle_button' => '切换',
            'admin_forcesub_set_link_button' => '设置链接',
            'admin_forcesub_set_channel_button' => '设置频道',
            'admin_forcesub_link_prompt' => '请提供邀请链接或备用链接。',
            'admin_forcesub_link_updated' => '链接已更新。',
            'admin_forcesub_channel_prompt' => '请按 ID|https://t.me/... 格式提供频道 ID 和链接。',
            'admin_forcesub_channel_updated' => '频道已更新。',
            'admin_referrals_hint' => '使用 /referrals <telegram_id> 查看合作伙伴。',
            'admin_referrals_toggle_button' => '切换推广计划',
            'admin_users_title' => "用户管理\n使用 /user <telegram_id>\n使用 /ban、/unban",
            'admin_user_id_prompt' => '请输入有效的 Telegram ID。',
            'admin_user_not_found' => '未找到该用户。',
            'admin_user_updated' => '用户已更新。',
            'admin_user_status_banned' => '已封禁',
            'admin_user_status_active' => '活跃',
            'admin_user_ban_button' => '封禁用户',
            'admin_user_unban_button' => '解封用户',
            'referral_disabled' => '推广计划已停用。',
            'referral_title' => 'Referral Program',
            'referral_link_label' => "Share link:\n__link__\nCode: __code__",
            'referral_stats' => "Invited: __invited__\nPending: __pending__\nAvailable: __eligible__$\nPaid: __rewarded__$",
            'referral_withdraw_button' => 'Withdraw earnings',

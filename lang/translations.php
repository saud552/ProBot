...
return [
    'ar' => [
        ...
        'strings' => [
            ...
            'numbers_welcome_title' => "🏆 - أهلاً بك عزيزي في قسم حسابات تيليجرام الجاهزة 💥.",
            'numbers_welcome_description' => "من خلال هذا القسم يمكنك شراء حسابات تيليجرام جاهز من أي دولة موجودة في الأسفل وبالسعر الموضح بجانبها بكل سهولة، بأسعار مغرية وضمان تفعيل الرقم ☑️ .",
            'numbers_welcome_instruction' => "♻️ - يرجى إختيار الدولة التي تريد شراء حساب منها ، جميع الدول بالأسفل متوفر لديها أرقام ☑️ .",
            'numbers_stars_welcome_title' => "🏆 - أهلاً بك عزيزي في قسم شراء حسابات تيليجرام بالنجوم 💥.",
            'numbers_stars_welcome_description' => "من خلال هذا القسم يمكنك شراء حسابات تيليجرام جاهز من أي دولة موجودة في الأسفل وبالسعر الموضح بجانبها (بالدولار والنجوم) بكل سهولة، بأسعار مغرية وضمان تفعيل الرقم ☑️ .",
            'numbers_stars_welcome_instruction' => "♻️ - يرجى إختيار الدولة التي تريد شراء حساب منها ، جميع الدول بالأسفل متوفر لديها أرقام ☑️ .",
            ...
            'admin_section_wallet' => 'الرصيد',
            'admin_section_catalog' => 'الكتالوج',
            'admin_section_pricing' => 'التسعير',
            'admin_section_content' => 'المحتوى',
            'admin_section_broadcast' => 'الإذاعة',
            'admin_section_maintenance' => 'الصيانة',
            'admin_section_agents' => 'الوكلاء',
            'admin_section_stats' => 'الإحصائيات',
            ...
            'admin_referrals_config_button' => 'تعديل المكافآت',
            'admin_referrals_config_prompt' => 'أرسل المكافأة الثابتة والنسبة والحد الأدنى مثل: 1.5|5|2',
            'admin_referrals_flat' => 'المكافأة الثابتة',
            'admin_referrals_percent' => 'النسبة المئوية',
            'admin_referrals_min_order' => 'أدنى طلب محسوب',
            ...
            'admin_wallet_title' => 'إدارة الرصيد',
            'admin_wallet_credit' => 'شحن رصيد',
            'admin_wallet_debit' => 'خصم رصيد',
            'admin_wallet_refund' => 'إسترجاع رصيد',
            'admin_prompt_wallet_user' => 'أرسل معرف المستخدم في تيليجرام.',
            'admin_wallet_amount_prompt' => 'أرسل المبلغ بالدولار.',
            'admin_wallet_invalid_amount' => 'أدخل رقمًا أكبر من الصفر.',
            'admin_wallet_credit_done' => 'تم شحن %0.2f$ لحساب %d.',
            'admin_wallet_debit_done' => 'تم خصم %0.2f$ من حساب %d.',
            'admin_wallet_refund_done' => 'تم رد %0.2f$ إلى حساب %d.',
            'admin_wallet_error' => 'تعذر تنفيذ العملية.',
            'admin_wallet_user_credit' => 'تم إضافة %0.2f$ إلى محفظتك.',
            'admin_wallet_user_debit' => 'تم خصم %0.2f$ من محفظتك بواسطة الإدارة.',
            'admin_wallet_user_refund' => 'تمت إضافة استرجاع بقيمة %0.2f$ إلى محفظتك.',
            'admin_wallet_refund_reference_prompt' => 'أرسل معرف الطلب بالشكل numbers:123 أو smm:45.',
            'admin_wallet_refund_invalid' => 'الرجاء إدخال الطلب بالشكل الصحيح (numbers:ID أو smm:ID).',
            'admin_wallet_refund_not_found' => 'لم يتم العثور على الطلب المحدد.',
            'admin_wallet_refund_already' => 'تمت معالجة هذا الطلب مسبقاً.',
            'admin_wallet_refund_confirm' => 'سيتم رد %0.2f$ على طلب %s. أرسل كلمة CONFIRM للتأكيد أو /cancel للإلغاء.',
            'admin_wallet_refund_done' => 'تم تنفيذ عملية الاسترجاع بنجاح.',
            'admin_catalog_title' => 'إدارة الكتالوج',
            'admin_catalog_numbers_title' => 'قائمة الدول',
            'admin_catalog_empty' => 'لا توجد بيانات حالياً.',
            'admin_catalog_numbers_list' => 'عرض الدول',
            'admin_catalog_numbers_add' => 'إضافة دولة',
            'admin_catalog_numbers_remove' => 'حذف دولة',
            'admin_catalog_numbers_import' => 'استيراد أسعار',
            'admin_catalog_numbers_auto_import' => 'استيراد الدول تلقائياً',
            'admin_catalog_set_margin' => 'تحديد نسبة الربح للأرقام',
            'admin_catalog_country_prompt' => 'أرسل البيانات بالشكل CODE|Name|PriceUSD|ProviderID|Margin%.',
            'admin_catalog_remove_prompt' => 'أرسل رمز الدولة المراد حذفها.',
            'admin_catalog_import_prompt' => 'أرسل كل دولة في سطر بالشكل CODE PRICE.',
            'admin_catalog_import_done' => 'تم تحديث %d دولة.',
            'admin_catalog_auto_import_done' => 'تم استيراد %d دولة بنجاح مع تطبيق نسبة ربح %0.2f%%.',
            'admin_catalog_auto_import_error' => 'فشل استيراد الدول من المزود.',
            'admin_catalog_margin_updated' => 'تم تحديث نسبة الربح إلى %0.2f%% لجميع الدول (%d دولة).',
            'admin_catalog_not_found' => 'الدولة غير موجودة.',
            'admin_smm_categories' => 'فئات SMM',
            'admin_smm_services' => 'خدمات SMM',
            'admin_smm_categories_title' => 'فئات الرشق',
            'admin_smm_services_title' => 'خدمات الرشق',
            'admin_smm_empty' => 'لا توجد عناصر.',
            'admin_smm_add_category' => 'إضافة فئة',
            'admin_smm_remove_category' => 'حذف فئة',
            'admin_smm_add_service' => 'إضافة خدمة',
            'admin_smm_remove_service' => 'حذف خدمة',
            'admin_smm_category_prompt' => 'أرسل CODE|Name|Caption|Sort.',
            'admin_smm_category_remove_prompt' => 'أرسل رمز الفئة.',
            'admin_smm_service_prompt' => 'أرسل CATEGORY|Provider|Name|Rate|Min|Max|Currency.',
            'admin_smm_service_remove_prompt' => 'أرسل رقم الخدمة.',
            'admin_smm_category_not_found' => 'لم يتم العثور على الفئة.',
            'admin_pricing_title' => 'إعدادات التسعير',
            'admin_pricing_margin_label' => 'هامش الربح العام',
            'admin_transfer_fee_label' => 'رسوم التحويل',
            'admin_transfer_min_label' => 'الحد الأدنى للتحويل',
            'admin_pricing_set_margin' => 'تعديل الهامش',
            'admin_pricing_set_custom' => 'سعر مخصص',
            'admin_pricing_margin_prompt' => 'أرسل النسبة المئوية للأرباح (مثال 10 أو 15 أو 12.5). سيتم إضافة هذه النسبة إلى سعر الأرقام من المزود.',
            'admin_pricing_custom_prompt' => 'أرسل الكود والسعر مثل: US 1.75',
            'admin_transfer_fee_button' => 'رسوم التحويل',
            'admin_transfer_min_button' => 'حد التحويل',
            'admin_transfer_fee_prompt' => 'أرسل نسبة رسوم التحويل (مثال 2.5).',
            'admin_transfer_min_prompt' => 'أرسل أقل مبلغ للتحويل.',
            'admin_content_title' => 'إدارة المحتوى',
            'admin_content_start_label' => 'رسالة البداية',
            'admin_content_help_label' => 'رسالة الإرشاد',
            'admin_content_set_start' => 'تعديل الرسالة',
            'admin_content_set_help' => 'تعديل الإرشادات',
            'admin_content_start_prompt' => 'أرسل رسالة البداية (أو /clear للحذف).',
            'admin_content_help_prompt' => 'أرسل رسالة المساعدة (أو /clear للحذف).',
            'admin_content_saved' => 'تم الحفظ.',
            'admin_agents_title' => 'الوكلاء',
            'admin_agents_empty' => 'لا يوجد وكلاء.',
            'admin_agents_add_button' => 'إضافة وكيل',
            'admin_agents_remove_button' => 'حذف وكيل',
            'admin_agents_add_prompt' => 'أرسل الاسم واليوزر بالشكل: الاسم|username',
            'admin_agents_remove_prompt' => 'أرسل الاسم أو اليوزر للحذف.',
            'admin_agents_saved' => 'تم تحديث قائمة الوكلاء.',
            'admin_maintenance_title' => 'وضع الصيانة',
            'admin_maintenance_default' => 'البوت في وضع الصيانة حالياً.',
            'admin_maintenance_toggle' => 'تبديل الوضع',
            'admin_maintenance_set_message' => 'تعديل الرسالة',
            'admin_maintenance_message_prompt' => 'أرسل رسالة الصيانة أو /clear للحذف.',
            'admin_broadcast_prompt' => 'أرسل محتوى الرسالة ليتم إرسالها للجميع.',
            'admin_broadcast_done' => 'تم إرسال الرسالة إلى %d مستخدم.',
            'admin_stats_users' => 'عدد المستخدمين',
            'admin_stats_agents' => 'عدد الوكلاء',
            'admin_stats_referrals' => 'الإحالات مفعلة',
    ...
    'en' => [
        ...
        'strings' => [
            ...
            'numbers_welcome_title' => "🏆 - Welcome to the Ready Telegram Accounts Section 💥.",
            'numbers_welcome_description' => "Through this section, you can easily purchase ready Telegram accounts from any country listed below with the price shown next to it, at attractive prices with number activation guarantee ☑️ .",
            'numbers_welcome_instruction' => "♻️ - Please choose the country you want to purchase an account from, all countries below have available numbers ☑️ .",
            'numbers_stars_welcome_title' => "🏆 - Welcome to the Telegram Accounts Purchase Section (Stars) 💥.",
            'numbers_stars_welcome_description' => "Through this section, you can easily purchase ready Telegram accounts from any country listed below with the price shown next to it (in USD and Stars), at attractive prices with number activation guarantee ☑️ .",
            'numbers_stars_welcome_instruction' => "♻️ - Please choose the country you want to purchase an account from, all countries below have available numbers ☑️ .",
            ...
            'support_ticket_created' => 'Ticket created. Our team will contact you soon.',
            'support_ticket_list_title' => 'My Tickets',
            'support_ticket_list_empty' => 'No tickets yet.',
            'support_ticket_reply_prompt' => 'Send your reply.',
            ...
            'support_waiting_for_admin' => 'Reply sent. Please wait for the support team.',
            ...
            'feature_disabled' => 'This section is currently disabled.',
            'admin_only' => 'This action is available to admins only.',
            ...
            'admin_prompt_star_price' => 'Send the new USD price per star.',
            'admin_star_price_updated' => 'Star price updated.',
            'admin_forcesub_title' => 'Forced Subscription',
            'admin_forcesub_toggle_button' => 'Toggle',
            'admin_forcesub_set_link_button' => 'Set Link',
            'admin_forcesub_set_channel_button' => 'Set Channel',
            'admin_forcesub_link_prompt' => 'Send the invite or fallback link.',
            'admin_forcesub_link_updated' => 'Link updated.',
            'admin_forcesub_channel_prompt' => 'Send the channel ID and link as ID|https://t.me/....',
            'admin_forcesub_channel_updated' => 'Channel updated.',
            'admin_referrals_hint' => 'Use /referrals <telegram_id> to review the partner.',
            'admin_referrals_toggle_button' => 'Toggle referral program',
            'admin_users_title' => "User controls\nUse /user <telegram_id>\nCommands /ban and /unban",
    ...
    'ru' => [
        ...
        'strings' => [
            ...
            'support_intro' => 'Нужна помощь? Откройте тикет, и мы скоро ответим.',
            'support_new_ticket_button' => 'Открыть тикет',
            'support_my_tickets_button' => 'Мои тикеты',
            'support_ticket_subject_prompt' => 'Отправьте короткую тему для тикета.',
            'support_ticket_message_prompt' => 'Опишите вашу проблему.',
            'support_ticket_created' => 'Тикет создан, мы свяжемся с вами в ближайшее время.',
            'support_ticket_list_title' => 'Мои тикеты',
            'support_ticket_list_empty' => 'Тикетов пока нет.',
            'support_ticket_reply_prompt' => 'Введите ваш ответ.',
            'support_ticket_closed' => 'Тикет закрыт. Спасибо.',
            'support_ticket_reply_button' => 'Ответить',
            'support_ticket_close_button' => 'Закрыть',
            'support_ticket_header' => 'Тикет',
            'support_ticket_status_label' => 'Статус',
            'support_ticket_subject_label' => 'Тема',
            'support_admin_label' => 'Поддержка',
            'support_user_label' => 'Вы',
            'support_waiting_for_admin' => 'Ответ отправлен. Ожидайте поддержки.',
            'support_admin_reply_notice' => 'Поддержка ответила на ваш тикет.',
            'support_admin_reply_sent' => 'Ответ отправлен пользователю.',
            'support_input_cancelled' => 'Действие отменено.',
            'user_banned' => 'Доступ к боту ограничен.',
            'feature_disabled' => 'Этот раздел отключён.',
            'admin_only' => 'Только для администраторов.',
            'admin_panel_button' => 'Панель админа',
            'admin_panel_title' => 'Панель администратора',
            'admin_section_tickets' => 'Тикеты',
            'admin_section_users' => 'Пользователи',
            'admin_section_features' => 'Разделы',
            'admin_section_stars' => 'Оплата Stars',
            'admin_section_forcesub' => 'Обязательная подписка',
            'admin_section_referrals' => 'Партнёрка',
            'admin_features_title' => 'Переключение разделов',
            'admin_stars_title' => 'Настройки оплаты Stars',
            'admin_stars_enabled_label' => 'Статус',
            'admin_stars_price_label' => 'USD за 1 Star',
            'admin_stars_toggle_button' => 'Вкл/Выкл',
            'admin_stars_set_price_button' => 'Задать цену',
            'admin_prompt_star_price' => 'Отправьте новую стоимость звезды в USD.',
            'admin_star_price_updated' => 'Стоимость Stars обновлена.',
            'admin_forcesub_title' => 'Обязательная подписка',
            'admin_forcesub_toggle_button' => 'Вкл/Выкл',
            'admin_forcesub_set_link_button' => 'Изменить ссылку',
            'admin_forcesub_set_channel_button' => 'Изменить канал',
            'admin_forcesub_link_prompt' => 'Отправьте ссылку приглашения или резервную ссылку.',
            'admin_forcesub_link_updated' => 'Ссылка обновлена.',
            'admin_forcesub_channel_prompt' => 'Отправьте ID канала и ссылку в формате ID|https://t.me/...',
            'admin_forcesub_channel_updated' => 'Канал обновлён.',
            'admin_referrals_hint' => 'Используйте /referrals <telegram_id>, чтобы проверить партнёра.',
            'admin_referrals_toggle_button' => 'Вкл/Выкл партнёрку',
            'admin_users_title' => "Управление пользователями\nИспользуйте /user <telegram_id>\nКоманды /ban и /unban",
            'admin_user_id_prompt' => 'Отправьте корректный Telegram ID.',
            ...
            'admin_user_ban_button' => 'Заблокировать',
            'admin_user_unban_button' => 'Разблокировать',
            'referral_disabled' => 'Партнёрская программа отключена.',
            'referral_title' => 'Referral Program',
            'referral_link_label' => "Share link:\n__link__\nCode: __code__",
            'referral_stats' => "Invited: __invited__\nPending: __pending__\nAvailable: __eligible__$\nPaid: __rewarded__$",
            'referral_withdraw_button' => 'Withdraw earnings',
    ...
    'fa' => [
        ...
        'strings' => [
            ...
            'support_intro' => 'کمک می‌خواهید؟ یک تیکت باز کنید تا به‌زودی پاسخ دهیم.',
            'support_new_ticket_button' => 'ایجاد تیکت',
            'support_my_tickets_button' => 'تیکت‌های من',
            'support_ticket_subject_prompt' => 'یک عنوان کوتاه برای تیکت ارسال کنید.',
            'support_ticket_message_prompt' => 'جزئیات مشکل را توضیح دهید.',
            'support_ticket_created' => 'تیکت ایجاد شد، به‌زودی پاسخ خواهیم داد.',
            'support_ticket_list_title' => 'تیکت‌های من',
            'support_ticket_list_empty' => 'هنوز تیکتی ثبت نشده است.',
            'support_ticket_reply_prompt' => 'پاسخ خود را ارسال کنید.',
            'support_ticket_closed' => 'تیکت بسته شد. متشکریم.',
            'support_ticket_reply_button' => 'پاسخ',
            'support_ticket_close_button' => 'بستن',
            'support_ticket_header' => 'تیکت',
            'support_ticket_status_label' => 'وضعیت',
            'support_ticket_subject_label' => 'عنوان',
            'support_admin_label' => 'پشتیبانی',
            'support_user_label' => 'شما',
            'support_waiting_for_admin' => 'پاسخ ارسال شد. لطفاً منتظر تیم پشتیبانی باشید.',
            'support_admin_reply_notice' => 'پشتیبانی به تیکت شما پاسخ داد.',
            'support_admin_reply_sent' => 'پاسخ برای کاربر ارسال شد.',
            'support_input_cancelled' => 'عملیات لغو شد.',
            'user_banned' => 'دسترسی شما به این ربات محدود شده است.',
            'feature_disabled' => 'این بخش در حال حاضر غیرفعال است.',
            'admin_only' => 'این اقدام فقط برای مدیران است.',
            'admin_panel_button' => 'پنل مدیریت',
            'admin_panel_title' => 'پنل مدیر',
            'admin_section_tickets' => 'تیکت‌ها',
            'admin_section_users' => 'کاربران',
            'admin_section_features' => 'بخش‌ها',
            'admin_section_stars' => 'پرداخت ستاره',
            'admin_section_forcesub' => 'عضویت اجباری',
            'admin_section_referrals' => 'معرفی‌ها',
            'admin_features_title' => 'کنترل بخش‌ها',
            'admin_stars_title' => 'تنظیمات پرداخت ستاره',
            'admin_stars_enabled_label' => 'وضعیت',
            'admin_stars_price_label' => 'قیمت هر ستاره (دلار)',
            'admin_stars_toggle_button' => 'فعال/غیرفعال',
            'admin_stars_set_price_button' => 'تنظیم قیمت',
            'admin_prompt_star_price' => 'مقدار دلار برای هر ستاره را ارسال کنید.',
            'admin_star_price_updated' => 'قیمت ستاره به‌روزرسانی شد.',
            'admin_forcesub_title' => 'تنظیمات عضویت اجباری',
            'admin_forcesub_toggle_button' => 'فعال/غیرفعال',
            'admin_forcesub_set_link_button' => 'تغییر لینک',
            'admin_forcesub_set_channel_button' => 'تغییر کانال',
            'admin_forcesub_link_prompt' => 'لینک دعوت یا لینک جایگزین را ارسال کنید.',
            'admin_forcesub_link_updated' => 'لینک به‌روزرسانی شد.',
            'admin_forcesub_channel_prompt' => 'شناسه کانال و لینک را به صورت ID|https://t.me/... ارسال کنید.',
            'admin_forcesub_channel_updated' => 'کانال به‌روزرسانی شد.',
            'admin_referrals_hint' => 'برای بررسی شریک از ‎/referrals <telegram_id>‎ استفاده کنید.',
            'admin_referrals_toggle_button' => 'فعال/غیرفعال برنامه معرفی',
            'admin_users_title' => "مدیریت کاربر\nاز ‎/user <telegram_id>‎ و دستورات ‎/ban /unban استفاده کنید",
            'admin_user_id_prompt' => 'یک شناسه تلگرام معتبر ارسال کنید.',
            'admin_user_not_found' => 'کاربر پیدا نشد.',
            'admin_user_updated' => 'کاربر به‌روزرسانی شد.',
            'admin_user_status_banned' => 'مسدود',
            'admin_user_status_active' => 'فعال',
            'admin_user_ban_button' => 'مسدود کردن',
            'admin_user_unban_button' => 'رفع مسدودیت',
            'referral_disabled' => 'برنامه معرفی غیرفعال است.',
            'referral_title' => 'برنامه معرفی',
            'referral_link_label' => "لینک دعوت:\n__link__\nکد: __code__",
            'referral_stats' => "دعوت‌شده‌ها: __invited__\nدر انتظار: __pending__\nموجود: __eligible__$\nپرداخت‌شده: __rewarded__$",
            'referral_withdraw_button' => 'برداشت درآمد',
            'referral_withdraw_success' => '__amount__$ به کیف پول شما منتقل شد.',
            'referral_no_rewards' => 'پاداشی برای برداشت موجود نیست.',
            'referral_attached' => 'ارجاع با موفقیت ثبت شد.',
            'button_refresh' => 'به‌روزرسانی',
        ],
    ],
    'cht' => [
        'label' => '繁體中文 🇨🇳',
        ...
        'strings' => [
            ...
            'support_intro' => '需要協助嗎？請提交工單，我們會儘快回覆。',
            'support_new_ticket_button' => '提交工單',
            'support_my_tickets_button' => '我的工單',
            'support_ticket_subject_prompt' => '請填寫工單的簡短主題。',
            'support_ticket_message_prompt' => '請描述您的問題。',
            'support_ticket_created' => '工單已建立，我們會儘快聯繫您。',
            'support_ticket_list_title' => '我的工單',
            'support_ticket_list_empty' => '暫無工單。',
            'support_ticket_reply_prompt' => '請輸入您的回覆。',
            'support_ticket_closed' => '工單已關閉，感謝使用。',
            'support_ticket_reply_button' => '回覆',
            'support_ticket_close_button' => '關閉',
            'support_ticket_header' => '工單',
            'support_ticket_status_label' => '狀態',
            'support_ticket_subject_label' => '主題',
            'support_admin_label' => '客服',
            'support_user_label' => '您',
            'support_waiting_for_admin' => '回覆已送出，請等待客服處理。',
            'support_admin_reply_notice' => '客服已回覆您的工單。',
            'support_admin_reply_sent' => '回覆已傳送給用戶。',
            'support_input_cancelled' => '操作已取消。',
            'user_banned' => '您已被禁止使用此機器人。',
            'feature_disabled' => '此功能目前停用。',
            'admin_only' => '僅限管理員。',
            'admin_panel_button' => '管理面板',
            'admin_panel_title' => '管理員面板',
            'admin_section_tickets' => '工單',
            'admin_section_users' => '用戶',
            'admin_section_features' => '功能',
            'admin_section_stars' => 'Stars 付款',
            'admin_section_forcesub' => '強制關注',
            'admin_section_referrals' => '推廣計畫',
            'admin_features_title' => '功能開關',
            'admin_stars_title' => 'Stars 付款設定',
            'admin_stars_enabled_label' => '狀態',
            'admin_stars_price_label' => '每個 Star 的美元價',
            'admin_stars_toggle_button' => '切換',
            'admin_stars_set_price_button' => '設定價格',
            'admin_prompt_star_price' => '請輸入每顆 Star 的美元價格。',
            'admin_star_price_updated' => 'Star 價格已更新。',
            'admin_forcesub_title' => '強制關注設定',
            'admin_forcesub_toggle_button' => '切換',
            'admin_forcesub_set_link_button' => '設定連結',
            'admin_forcesub_set_channel_button' => '設定頻道',
            'admin_forcesub_link_prompt' => '請提供邀請連結或備用連結。',
            'admin_forcesub_link_updated' => '連結已更新。',
            'admin_forcesub_channel_prompt' => '請按 ID|https://t.me/... 格式提供頻道 ID 和連結。',
            'admin_forcesub_channel_updated' => '頻道已更新。',
            'admin_referrals_hint' => '使用 /referrals <telegram_id> 檢視合作夥伴。',
            'admin_referrals_toggle_button' => '切換推廣計畫',
            'admin_users_title' => "用戶管理\n使用 /user <telegram_id>\n使用 /ban、/unban",
            'admin_user_id_prompt' => '請輸入有效的 Telegram ID。',
            'admin_user_not_found' => '找不到該用戶。',
            'admin_user_updated' => '用戶已更新。',
            'admin_user_status_banned' => '已封鎖',
            'admin_user_status_active' => '活躍',
            'admin_user_ban_button' => '封鎖用戶',
            'admin_user_unban_button' => '解除封鎖',
            'referral_disabled' => '推廣計畫已停用。',
            'referral_title' => '推薦計畫',
            'referral_link_label' => "分享連結:\n__link__\n代碼: __code__",
            'referral_stats' => "邀請: __invited__\n待處理: __pending__\n可領取: __eligible__$\n已發放: __rewarded__$",
            'referral_withdraw_button' => '提領收益',
            'referral_withdraw_success' => '已將 __amount__$ 匯入您的錢包。',
            'referral_no_rewards' => '目前沒有可領取的推薦獎勵。',
            'referral_attached' => '推薦已成功記錄。',
            'button_refresh' => '重新整理',
        ],
    ],
    'chb' => [
        ...
        'strings' => [
            ...
            'support_intro' => 'Yardıma mı ihtiyacın var? Bir talep oluştur, kısa sürede dönüş yapalım.',
            'support_new_ticket_button' => 'Talep aç',
            'support_my_tickets_button' => 'Taleplerim',
            'support_ticket_subject_prompt' => 'Talebin için kısa bir başlık gönder.',
            'support_ticket_message_prompt' => 'Sorununu detaylıca yaz.',
            'support_ticket_created' => 'Talep oluşturuldu, en kısa sürede dönüş yapacağız.',
            'support_ticket_list_title' => 'Taleplerim',
            'support_ticket_list_empty' => 'Henüz talep yok.',
            'support_ticket_reply_prompt' => 'Yanıtını yaz.',
            'support_ticket_closed' => 'Talep kapatıldı. Teşekkürler.',
            'support_ticket_reply_button' => 'Yanıtla',
            'support_ticket_close_button' => 'Kapat',
            'support_ticket_header' => 'Talep',
            'support_ticket_status_label' => 'Durum',
            'support_ticket_subject_label' => 'Konu',
            'support_admin_label' => 'Destek',
            'support_user_label' => 'Sen',
            'support_waiting_for_admin' => 'Yanıtın gönderildi. Lütfen destek ekibini bekle.',
            'support_admin_reply_notice' => 'Destek ekibi talebine yanıt verdi.',
            'support_admin_reply_sent' => 'Yanıt kullanıcıya iletildi.',
            'support_input_cancelled' => 'İşlem iptal edildi.',
            'user_banned' => 'Bu bota erişiminiz kısıtlandı.',
            'feature_disabled' => 'Bu bölüm şu anda devre dışı.',
            'admin_only' => 'Bu işlem sadece yöneticiler için.',
            'admin_panel_button' => 'Yönetim Paneli',
            'admin_panel_title' => 'Yönetici Paneli',
            'admin_section_tickets' => 'Destek',
            'admin_section_users' => 'Kullanıcılar',
            'admin_section_features' => 'Bölümler',
            'admin_section_stars' => 'Stars ödemesi',
            'admin_section_forcesub' => 'Zorunlu abonelik',
            'admin_section_referrals' => 'Referanslar',
            'admin_features_title' => 'Bölüm anahtarları',
            'admin_stars_title' => 'Stars ödeme ayarları',
            'admin_stars_enabled_label' => 'Durum',
            'admin_stars_price_label' => '1 Star USD değeri',
            'admin_stars_toggle_button' => 'Aç / Kapat',
            'admin_stars_set_price_button' => 'Fiyat belirle',
            'admin_prompt_star_price' => 'Bir Star için dolar değerini gönder.',
            'admin_star_price_updated' => 'Star fiyatı güncellendi.',
            'admin_forcesub_title' => 'Zorunlu abonelik ayarları',
            'admin_forcesub_toggle_button' => 'Aç / Kapat',
            'admin_forcesub_set_link_button' => 'Link değiştir',
            'admin_forcesub_set_channel_button' => 'Kanal değiştir',
            'admin_forcesub_link_prompt' => 'Davet ya da yedek linki gönder.',
            'admin_forcesub_link_updated' => 'Link güncellendi.',
            'admin_forcesub_channel_prompt' => 'Kanal ID ve linkini ID|https://t.me/... formatında gönder.',
            'admin_forcesub_channel_updated' => 'Kanal güncellendi.',
            'admin_referrals_hint' => '/referrals <telegram_id> komutuyla iş ortağını incele.',
            'admin_referrals_toggle_button' => 'Referansları aç/kapat',
            'admin_users_title' => "Kullanıcı yönetimi\n/user <telegram_id>\n/ban ve /unban komutları",
            'admin_user_id_prompt' => 'Geçerli bir Telegram ID gönder.',
            'admin_user_not_found' => 'Kullanıcı bulunamadı.',
            'admin_user_updated' => 'Kullanıcı güncellendi.',
            'admin_user_status_banned' => 'ENGELLİ',
            'admin_user_status_active' => 'AKTİF',
            'admin_user_ban_button' => 'Kullanıcıyı engelle',
            'admin_user_unban_button' => 'Engeli kaldır',
            'referral_disabled' => 'Referans programı devre dışı.',
            'referral_title' => 'Referral Program',
            'referral_link_label' => "Share link:\n__link__\nCode: __code__",
            'referral_stats' => "Invited: __invited__\nPending: __pending__\nAvailable: __eligible__$\nPaid: __rewarded__$",
            'referral_withdraw_button' => 'Withdraw earnings',
    ...
    'tr' => [
        ...
        'strings' => [
            ...
            'admin_section_forcesub' => 'Forced Subscription',
            'admin_section_referrals' => 'Referrals',
            'admin_section_wallet' => 'Wallet',
            'admin_section_catalog' => 'Catalog',
            'admin_section_pricing' => 'Pricing',
            'admin_section_content' => 'Content',
            'admin_section_broadcast' => 'Broadcast',
            'admin_section_maintenance' => 'Maintenance',
            'admin_section_agents' => 'Agents',
            'admin_section_stats' => 'Stats',
            'admin_features_title' => 'Feature toggles',
            'admin_stars_title' => 'Stars payments',
            'admin_stars_enabled_label' => 'Enabled',
            'admin_stars_price_label' => 'USD per star',
            ...
            'admin_referrals_config_button' => 'Configure rewards',
            'admin_referrals_config_prompt' => 'Send flat reward, percent, min order e.g. 1.5|5|2',
            'admin_referrals_flat' => 'Flat reward',
            'admin_referrals_percent' => 'Percent',
            'admin_referrals_min_order' => 'Min order',
            ...
            'admin_user_ban_button' => 'Ban user',
            'admin_user_unban_button' => 'Unban user',
            'admin_wallet_title' => 'Wallet management',
            'admin_wallet_credit' => 'Credit balance',
            'admin_wallet_debit' => 'Debit balance',
            'admin_wallet_refund' => 'Issue refund',
            'admin_prompt_wallet_user' => 'Send the Telegram ID.',
            'admin_wallet_amount_prompt' => 'Send the amount in USD.',
            'admin_wallet_invalid_amount' => 'Please send a positive number.',
            'admin_wallet_credit_done' => 'Credited %0.2f USD to %d.',
            'admin_wallet_debit_done' => 'Debited %0.2f USD from %d.',
            'admin_wallet_refund_done' => 'Refunded %0.2f USD to %d.',
            'admin_wallet_error' => 'Unable to complete the operation.',
            'admin_wallet_user_credit' => 'An administrator added %0.2f USD to your wallet.',
            'admin_wallet_user_debit' => 'An administrator removed %0.2f USD from your wallet.',
            'admin_wallet_user_refund' => 'A refund of %0.2f USD was added to your wallet.',
            'admin_wallet_refund_reference_prompt' => 'Send the order reference as numbers:123 or smm:45.',
            'admin_wallet_refund_invalid' => 'Please follow the format numbers:ID or smm:ID.',
            'admin_wallet_refund_not_found' => 'Order not found.',
            'admin_wallet_refund_already' => 'This order has already been processed.',
            'admin_wallet_refund_confirm' => 'Refund %0.2f USD for %s? Reply CONFIRM to proceed or /cancel to abort.',
            'admin_wallet_refund_done' => 'Refund completed successfully.',
            'admin_catalog_title' => 'Catalog management',
            'admin_catalog_numbers_title' => 'Numbers catalog',
            'admin_catalog_empty' => 'No entries yet.',
            'admin_catalog_numbers_list' => 'List countries',
            'admin_catalog_numbers_add' => 'Add country',
            'admin_catalog_numbers_remove' => 'Remove country',
            'admin_catalog_numbers_import' => 'Import prices',
            'admin_catalog_numbers_auto_import' => 'Auto Import Countries',
            'admin_catalog_set_margin' => 'Set Numbers Profit Margin',
            'admin_catalog_auto_import_done' => 'Successfully imported %d countries with %0.2f%% margin applied.',
            'admin_catalog_auto_import_error' => 'Failed to fetch countries from provider.',
            'admin_catalog_margin_updated' => 'Profit margin updated to %0.2f%% for all countries (%d countries).',
            'admin_catalog_country_prompt' => 'Send CODE|Name|PriceUSD|ProviderID|Margin%.',
            'admin_catalog_remove_prompt' => 'Send the country code to remove.',
            'admin_catalog_import_prompt' => 'Send CODE PRICE per line.',
            'admin_catalog_import_done' => 'Updated %d countries.',
            'admin_catalog_not_found' => 'Country not found.',
            'admin_smm_categories' => 'SMM categories',
            'admin_smm_services' => 'SMM services',
            'admin_smm_categories_title' => 'SMM Categories',
            'admin_smm_services_title' => 'SMM Services',
            'admin_smm_empty' => 'No entries yet.',
            'admin_smm_add_category' => 'Add category',
            'admin_smm_remove_category' => 'Remove category',
            'admin_smm_add_service' => 'Add service',
            'admin_smm_remove_service' => 'Remove service',
            'admin_smm_category_prompt' => 'Send CODE|Name|Caption|Sort.',
            'admin_smm_category_remove_prompt' => 'Send the category code.',
            'admin_smm_service_prompt' => 'Send CATEGORY|Provider|Name|Rate|Min|Max|Currency.',
            'admin_smm_service_remove_prompt' => 'Send the service ID.',
            'admin_smm_category_not_found' => 'Category not found.',
            'admin_pricing_title' => 'Pricing settings',
            'admin_pricing_margin_label' => 'Global margin',
            'admin_transfer_fee_label' => 'Transfer fee',
            'admin_transfer_min_label' => 'Minimum transfer',
            'admin_pricing_set_margin' => 'Set margin',
            'admin_pricing_set_custom' => 'Custom price',
            'admin_pricing_margin_prompt' => 'Send the percentage (e.g. 12.5).',
            'admin_pricing_custom_prompt' => 'Send code and price like: US 1.75',
            'admin_content_title' => 'Content settings',
            'admin_content_start_label' => 'Start message',
            'admin_content_help_label' => 'Help text',
            'admin_content_set_start' => 'Update start',
            'admin_content_set_help' => 'Update help',
            'admin_content_start_prompt' => 'Send the start message (or /clear).',
            'admin_content_help_prompt' => 'Send the help text (or /clear).',
            'admin_content_saved' => 'Saved.',
            'admin_agents_title' => 'Agents',
            'admin_agents_empty' => 'No agents yet.',
            'admin_agents_add_button' => 'Add agent',
            'admin_agents_remove_button' => 'Remove agent',
            'admin_agents_add_prompt' => 'Send Name|username (username optional).',
            'admin_agents_remove_prompt' => 'Send the name or username to remove.',
            'admin_agents_saved' => 'Agents updated.',
            'admin_maintenance_title' => 'Maintenance mode',
            'admin_maintenance_default' => 'The bot is currently under maintenance.',
            'admin_maintenance_toggle' => 'Toggle',
            'admin_maintenance_set_message' => 'Set message',
            'admin_maintenance_message_prompt' => 'Send the maintenance message or /clear.',
            'admin_broadcast_prompt' => 'Send the message to broadcast.',
            'admin_broadcast_done' => 'Broadcast sent to %d users.',
            'admin_stats_users' => 'Users',
            'admin_stats_agents' => 'Agents',
            'admin_stats_referrals' => 'Referrals enabled',
            'referral_disabled' => 'Referral program is disabled.',
            'referral_title' => 'Referral Program',
            'referral_link_label' => "Share link:\n__link__\nCode: __code__",
            'referral_stats' => "Invited: __invited__\nPending: __pending__\nAvailable: __eligible__$\nPaid: __rewarded__$",
